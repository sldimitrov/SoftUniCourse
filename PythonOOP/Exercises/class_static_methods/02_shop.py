...
class Shop:
    """
    Initialise Shop Class
    """
    def __init__(self, name: str, type_shop: str, capacity: int):
        """
        This class method is called the constructor
        """
        self.name: str = name
        self.type: str = type_shop
    ...
    def small_shop(cls, name: str, type_shop: str):
        """
        A class method that takes the class as a parameter
        """
        return cls(name, type_shop, 10)

    def add_item(self, item_name: str) -> str:
        """
        This method add items to the collection of items: [dict]
        """
