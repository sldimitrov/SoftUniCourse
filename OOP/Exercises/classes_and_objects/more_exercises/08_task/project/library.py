...
class Library:
    ...
    def __init__(self):
        self.user_records = []  # [User(1, "Pesho"), User(2, "Ivan"), ...]
        self.books_available = {}  # {"Svetlin Nakov": ["Python Basics", "JS basics"]...}
        self.rented_books = {}  # {"Pesho": {"Python Baiscs": 30, "JS basics": 10}, ...}
